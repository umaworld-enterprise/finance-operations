...
class BaseRepository(Generic[ModelT]):
    ...
    async def create(self, **kwargs: Any) -> ModelT:
        # No refresh needed: Base sets eager_defaults, so server-generated
        # values come back via RETURNING on the INSERT itself.
    ...
    async def update(self, instance: ModelT, **kwargs: Any) -> ModelT:
        # No refresh: eager_defaults fetches onupdate values via RETURNING,
        # and skipping refresh keeps loaded relationships intact.
