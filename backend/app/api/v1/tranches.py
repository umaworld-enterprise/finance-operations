...
from app.schemas.tranche import AdjustmentResponse, TrancheResponse, TrancheUpdate
from app.services.adjustment_service import AdjustmentService
from app.services.notification_service import notify_tranche_event, notify_tranche_updated
...
async def upload_tranche_tt_copy(
    ...
    action — the merchandiser is notified either way.
    """
    ...
    tranche, auto_paid = await svc.attach_tt_copy(
    ...
    background_tasks.add_task(
        notify_tranche_event, request_id, tranche_id,
        "paid" if auto_paid else "tt_attached",
    )
